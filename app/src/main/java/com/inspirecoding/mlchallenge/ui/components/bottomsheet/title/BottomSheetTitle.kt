package com.inspirecoding.mlchallenge.ui.components.bottomsheet.title
...
fun BottomSheetTitle(
    title: String?,
    headerBackground: Color = YellowMain,
            ...
            if(!emptyBottomSheet && showCloseButton) {
                Image(
                    modifier = Modifier
                        ...
                        .clickable { onClose() },
                    painter = painterResource(id = R.drawable.ml_challenge_ic_close),
